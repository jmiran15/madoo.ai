...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create madoo-ai-5f42
  fly apps create madoo-ai-5f42-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app madoo-ai-5f42
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app madoo-ai-5f42-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'madoo-ai-5f42-staging' does not match app name in config file 'madoo-ai-5f42'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name madoo-ai-5f42-db
  fly postgres attach --app madoo-ai-5f42 madoo-ai-5f42-db

  fly postgres create --name madoo-ai-5f42-staging-db
  fly postgres attach --app madoo-ai-5f42-staging madoo-ai-5f42-staging-db
  ```
